...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement/f:dosage/f:timing/f:repeat/f:when">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7belgium.org/fhir/medicationscheme/StructureDefinition/ExtDosageTime']) &gt;= 1">extension with URL = 'http://hl7belgium.org/fhir/medicationscheme/StructureDefinition/ExtDosageTime': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7belgium.org/fhir/medicationscheme/StructureDefinition/ExtDosageTime']) &lt;= 1">extension with URL = 'http://hl7belgium.org/fhir/medicationscheme/StructureDefinition/ExtDosageTime': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
