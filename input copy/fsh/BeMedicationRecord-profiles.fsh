Profile: MedicationLine
Parent: MedicationStatement
Title: "Medication Line"
Description: "The Medication Line as a profile of Medication Statement"

* identifier MS
//* extension contains http://hl7.org/fhir/StructureDefinition/artifact-version named businessVersion 1..1 MS // version 
...
/*
* dosage.extension contains XXXXXXXXXXXXXXXXXXXXXXXXXX named dosageOverride 0..1 MS
* extension contains XXXXXXXXXXXXXXXXXXXXXXXXXX named dosageOverride 0..1 MS
*/
...
* section[MedicationLine].entry only Reference(MedicationLine)
...
*/
* entry[MedicationLine] ^short = "Treatment lines associated with the patient"
* entry[MedicationLine].resource 1.. MS
* entry[MedicationLine].resource only MedicationLine
/*
